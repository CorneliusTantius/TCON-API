...
def insert_dummies():
    with get_connection('user.db') as con:
        ...
        entities = ('c69f9186-d0fa-11eb-84c8-569e2975b3f6','Wiliam','Tannuwijaya', 'william@gmail.com','081233439566','d2lsbGlhbQ==', 1, '') #william
        cur.execute(query, entities)
        entities = ('f0eb5bce-d0f4-11eb-84c8-569e2975b3f6', 'Brian Karnadi', 'Japar','brian@gmail.com','081233445216', 'YnJpYW4=', 1, '') #brian
        cur.execute(query, entities)
        entities = ('f0eb543e-dbfs-1s2b-84cv-5fs32975b3f6', 'Cornelius', 'Tantius','cornel@gmail.com','081237285566', 'Y29ybmVs', 1, '') #cornel
        cur.execute(query, entities)
        entities = ('f0eb5fje-34ns-11sb-82cv-5fs32j34g3f6', 'Ricky', '','ricky@gmail.com','081247444362', 'cmlja3k=', 1, '') #ricky
        cur.execute(query, entities)
        con.commit()
